...
class Game:
    ...
    def run_game_loop(self, level_speed):
        ...
        player_character = PlayerCharacter('asset/female.png', 375, 700, 50, 50)
        enemy_0 = EnemyCharacter('asset/enemy1.png', 20, 600, 50, 50)
        # Kecepatan naik ketika telah mencapai Goal
        enemy_0.SPEED *= level_speed

        # Membuat musuh baru
        enemy_1 = EnemyCharacter('asset/enemy2.png', self.width - 40, 400, 50, 50)
        enemy_1.SPEED *= level_speed 

        # Membuat musuh baru
        enemy_2 = EnemyCharacter('asset/enemy3.png', 60, 200, 50, 50)
        ...
        while not is_game_over:
            ...
            if player_character.detection_collision(enemy_0):
                is_game_over = True
                did_win = False
                text = font.render('YOU LOSE', True, WHITE_COLOR)
                ...
                is_game_over = True
                did_win = True
                text = font.render('NEXT ROUND', True, WHITE_COLOR)
                self.game_screen.blit(text, (240, 350))
                pygame.display.update()
                clock.tick(1)
                break
...
pygame.init()
new_game = Game('asset/futuristik_bg.jpg', SCREEN_TITLE, SCREEN_WIDTH, SCREEN_HEIGHT)
